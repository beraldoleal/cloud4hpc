...
\begin{enumerate}
    \item Quanto é a influência da latência na troca de mensagens de aplicações HPC?
    \item Quanto é a influência da largura de banda na troca de mensagens de aplicações HPC?
    \item Quão perto uma MV deve ficar (quantos hops) de outra MV afim de reduzir a latência na troca de mensagens?
    \item TBD
    \item TBD
\end{enumerate}
